...
drawLinearTimer:
    ...
    mov cx, [timeLeft]
    jcxz .finishedTimerSeconds
    
    mov word [temporalX], 240
    mov word [temporalY], 14
    mov si, cx
...
.timerSecondColumns:
    mov byte [es:bx], 15
    inc bx
    loop .timerSecondColumns
    
    add di, 320
    pop cx
    loop .timerSecondRows
    
    add word [temporalX], 1
    dec si
    jnz .drawTimerSecond
...
getRandomSpeed:
    ...
    ; SPEED POSIBILITIES: P(1)=1/8, P(2)=2/8 AND P(4)=5/8
